...
with col_b:
    ...
    if st.button("Get AI Insight"):
        if question:
            with st.spinner("AI is analyzing dashboard data..."):
                prompt = f"You are a stadium operations executive AI. Answer the following question based on general stadium best practices and predictive analytics: {question}"
