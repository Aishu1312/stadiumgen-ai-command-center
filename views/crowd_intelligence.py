...
st.session_state.current_page_context = "User is viewing the Crowd Intelligence page to monitor crowd density and zone wait times."
...
def display_crowd_dashboard():
    ...
    try:
        ...
        with col_b:
         ...
         st.error("Missing dependency: plotly. Please ensure requirements are installed.")
